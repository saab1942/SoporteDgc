  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="acolapsar">
      ...
      <ul class="nav navbar-nav">
        ...
        <li><a href="#"><span class="glyphicon glyphicon-wrench"></span> Incidencias</a></li>
        <li><a href="#"><span class="glyphicon glyphicon-bookmark"></span> Computadoras</a></li>
        <li class="active"><a href="listar.php"><span class="glyphicon glyphicon-print"></span> Impresoras</a></li>

        <!--Desplegable /!-->
        <li class="dropdown">
          <!--El datatoggle debe tener el mismo nombre que el li class/!-->
