...
<head>
	...
	<meta name="description" content="Formulario de Alta de Monitores">
	<meta name="keywords" content="Monitores, accesible, formulario">
...
<body>
    ...
    <h3 class="panel-title">Modificar Monitores</h3>
  	</div>
	...
	<div class="panel-body">
		...
		<?php 
			...
			// Este ID se recibe desde listar por el metodo Get
			$id = $_REQUEST['id'];		
			//-----------------------------------------------//
			...
			//Esto es especifico de Monitor
			echo   	"<label for='Pulgadas'>Pulgadas:</label>";
			echo   	"<input type='text' id='Pulgadas' name='Pulgadas' class='form-control' value=".$row["pulgadas"].">";

			// aqui hay un problema que hay resolver mañana todavia no se como hacerlo
			echo   	"<label for='tipo'>Tipo:</label>";
			echo   	"<select name='tipo' id='tipo' name='tipo' class='form-control' required >";
			echo   	"	<option value='CRT'>".$row["tipo"]."</option>";
