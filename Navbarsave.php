  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="acolapsar">
      ...
      <ul class="nav navbar-nav">
        ...
        <li><a href="#"><span class="glyphicon glyphicon-wrench"></span> Impresoras</a></li>
        <li><a href="#"><span class="glyphicon glyphicon-bookmark"></span> Computadoras</a></li>
        <li><a href="./impresoras/listar.php"><span class="glyphicon glyphicon-print"></span> Impresoras</a></li>
